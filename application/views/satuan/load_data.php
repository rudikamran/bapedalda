   ...
   <div class="box-body">
	...
	<table id="example1" class="table table-bordered table-striped">
		...
		<?php foreach ($item->result() as $r) { ?>
			<tr id="item<?php echo $r->id_satuan ?>">
				<td width="10"><?php echo $no++."."; ?></td>
				<td><?php echo $r->nm_satuan; ?></td>
				<td align="center">
					<p href="#edit" data-toggle="modal" onclick="get_id(<?php echo $r->id_satuan ?>)" class="btn btn-warning btn-sm"><span class="glyphicon glyphicon-edit"></span></p>
					<p href="" onclick="delete_item(<?php echo $r->id_satuan ?>)" class="btn btn-danger btn-sm"><span class="glyphicon glyphicon-trash"></span></p>
				</td>
			</tr>	
		<?php } ?>
		</tbody>
