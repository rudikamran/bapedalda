   ...
   <div class="box-body">
	...
	<table id="example2" class="table table-bordered table-striped">
		...
		<?php foreach ($item->result() as $r) { ?>
			<tr id="item<?php echo $r->id_kategori ?>">
				<td width="10"><?php echo $no++."."; ?></td>
				<td><?php echo $r->nm_kategori; ?></td>
				<td align="center" width="200">
					<p href="#edit" data-toggle="modal" onclick="get_id(<?php echo $r->id_kategori; ?>)" class="btn btn-warning btn-sm"><span class="glyphicon glyphicon-edit"></span></p>
					<p href="" onclick="delete_item(<?php echo $r->id_kategori ?>)" class="btn btn-danger btn-sm"><span class="glyphicon glyphicon-trash"></span></p>
				</td>	
			</tr>	
		<?php } ?>
		</tbody>
